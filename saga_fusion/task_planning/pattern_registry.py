    ...
    def default_patterns() -> list[PatternDefinition]:
        return [
            ...
            PatternDefinition(
                ...
                risk_level=TaskRisk.R3,
                keywords=("advanced malware triage", "malware triage workflow", "triage malware sample", "malware defensive workflow", "haz triage defensivo de malware", "triage defensivo de malware", "haz triage de malware", "prepara triage defensivo de malware"),
            ...
            PatternDefinition(
                ...
                risk_level=TaskRisk.R4,
                keywords=("ransomware response workflow", "ransomware defensive workflow", "ransomware response plan", "analiza posible ransomware", "posible ransomware", "ransomware"),
            ...
            PatternDefinition(
                ...
                risk_level=TaskRisk.R3,
                keywords=("webshell investigation workflow", "web shell investigation", "webshell defensive workflow", "revisa posible webshell", "posible webshell", "investiga posible webshell", "webshell"),
