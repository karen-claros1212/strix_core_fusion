    ...
    def default_patterns() -> list[PatternDefinition]:
        return [
            ...
            PatternDefinition(
                ...
                risk_level=TaskRisk.R3,
                keywords=("suspicious process workflow", "review suspicious process", "process defensive workflow"),
            ...
            PatternDefinition(
                ...
                risk_level=TaskRisk.R3,
                keywords=("phishing attachment workflow", "phishing attachment defensive", "review phishing attachment"),
